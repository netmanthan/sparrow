...
from sparrow.accounts.party import render_address
from sparrow.controllers.accounts_controller import get_taxes_and_charges
from sparrow.controllers.sales_and_purchase_return import get_rate_for_return
from sparrow.controllers.stock_controller import StockController
from sparrow.stock.doctype.item.item import set_item_default
from sparrow.stock.get_item_details import get_bin_details, get_conversion_factor
...
class SellingController(StockController):
	...
	def set_missing_lead_customer_details(self, for_validate=False):
		...
		if customer:
			from sparrow.accounts.party import _get_party_details
			...
			from sparrow.crm.doctype.lead.lead import get_lead_details
	...
	def validate_items(self):
		...
		from sparrow.controllers.buying_controller import validate_item_type
