...
def task(doc_name, from_doctype, to_doctype):
	from sparrow.accounts.doctype.payment_entry import payment_entry
	from sparrow.accounts.doctype.purchase_invoice import purchase_invoice
	from sparrow.accounts.doctype.sales_invoice import sales_invoice
	from sparrow.buying.doctype.purchase_order import purchase_order
	from sparrow.buying.doctype.supplier_quotation import supplier_quotation
	from sparrow.selling.doctype.quotation import quotation
	from sparrow.selling.doctype.sales_order import sales_order
	from sparrow.stock.doctype.delivery_note import delivery_note
	from sparrow.stock.doctype.purchase_receipt import purchase_receipt
