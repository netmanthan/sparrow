...
sparrow.buying.SubcontractingOrderController = class SubcontractingOrderController {
	setup() {
	...
	make_subcontracting_receipt() {
		frappe.model.open_mapped_doc({
			method: 'sparrow.subcontracting.doctype.subcontracting_order.subcontracting_order.make_subcontracting_receipt',
			frm: cur_frm,
...
extend_cscript(cur_frm.cscript, new sparrow.buying.SubcontractingOrderController({ frm: cur_frm }));