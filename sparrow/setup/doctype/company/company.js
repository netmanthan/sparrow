...
frappe.provide("sparrow.company");
...
frappe.ui.form.on("Company", {
	...
	setup: function(frm) {
		...
		sparrow.company.setup_queries(frm);
	...
	refresh: function(frm) {
		...
		sparrow.company.set_chart_of_accounts_options(frm.doc);
	},
	...
	delete_company_transactions: function(frm) {
		frappe.verify_password(function() {
			...
			function(data) {
				...
				frappe.call({
					method: "sparrow.setup.doctype.company.company.create_transaction_deletion_request",
					args: {
...
sparrow.company.set_chart_of_accounts_options = function(doc) {
	var selected_value = doc.chart_of_accounts;
	if(doc.country) {
		return frappe.call({
			method: "sparrow.accounts.doctype.account.chart_of_accounts.chart_of_accounts.get_charts_for_country",
			args: {
				"country": doc.country,
				"with_standard": true
			},
...
sparrow.company.setup_queries = function(frm) {
	$.each([
		...
		sparrow.company.set_custom_query(frm, v);
	});
...
sparrow.company.set_custom_query = function(frm, v) {
	var filters = {
