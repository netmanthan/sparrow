...
from sparrow.accounts.doctype.account.account import get_account_currency
from sparrow.setup.setup_wizard.operations.taxes_setup import setup_taxes_and_charges
...
class Company(NestedSet):
	...
	def create_default_accounts(self):
		from sparrow.accounts.doctype.account.chart_of_accounts.chart_of_accounts import create_charts
...
def install_country_fixtures(company, country):
	try:
		module_name = f"sparrow.regional.{frappe.scrub(country)}.setup.setup"
