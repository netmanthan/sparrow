...
from sparrow.accounts.utils import get_balance_on, get_count_on, get_fiscal_year
...
class EmailDigest(Document):
	...
	def get_msg_html(self):
		...
		from sparrow.setup.doctype.email_digest.quotes import get_random_quote
		...
		return frappe.render_template(
			"sparrow/setup/doctype/email_digest/templates/default.html", context, is_path=True
		)
