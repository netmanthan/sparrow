...
from sparrow.accounts.doctype.cash_flow_mapper.default_cash_flow_mapper import DEFAULT_MAPPERS
from sparrow.setup.default_energy_point_rules import get_default_energy_point_rules
from sparrow.setup.doctype.incoterm.incoterm import create_incoterms

from .default_success_action import get_default_success_action

default_mail_footer = """<div style="padding: 7px; text-align: right; color: #888"><small>Sent via
	<a style="color: #888" href="http://sparrow.org">Sparrow</a></div>"""
...
def check_setup_wizard_not_completed():
	if cint(frappe.db.get_single_value("System Settings", "setup_complete") or 0):
		message = """Sparrow can only be installed on a fresh site where the setup wizard is not completed.
...
def add_standard_navbar_items():
	...
	erpnext_navbar_items = [
		...
		},
		{
			...
			"item_type": "Route",
			"route": "https://github.com/netmanthan/sparrow/issues",
			"is_standard": 1,
		},
	]
...
def add_app_name():
	frappe.db.set_value("System Settings", None, "app_name", "Sparrow")
