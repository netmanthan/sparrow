...
from sparrow.manufacturing.doctype.bom.bom import get_children as get_bom_children
from sparrow.manufacturing.doctype.bom.bom import validate_bom_no
from sparrow.manufacturing.doctype.work_order.work_order import get_item_details
from sparrow.setup.doctype.item_group.item_group import get_item_group_defaults
from sparrow.stock.get_item_details import get_conversion_factor
from sparrow.stock.utils import get_or_make_bin
from sparrow.utilities.transaction_base import validate_uom_is_integer
...
class ProductionPlan(Document):
	...
	def make_work_order(self):
		from sparrow.manufacturing.doctype.work_order.work_order import get_default_warehouse
...
def get_materials_from_other_locations(item, warehouses, new_mr_items, company):
	from sparrow.stock.doctype.pick_list.pick_list import get_available_item_locations
...
def get_reserved_qty_for_production_plan(item_code, warehouse):
	from sparrow.manufacturing.doctype.work_order.work_order import get_reserved_qty_for_production
