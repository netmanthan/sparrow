...
from sparrow.stock.report.stock_ageing.stock_ageing import FIFOSlots, get_average_age
from sparrow.stock.utils import add_additional_uom_columns
...
class StockBalanceReport(object):
	...
	def set_company_currency(self) -> None:
		if self.filters.get("company"):
			self.company_currency = sparrow.get_company_currency(self.filters.get("company"))
		else:
