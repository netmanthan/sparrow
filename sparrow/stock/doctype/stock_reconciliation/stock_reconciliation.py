...
from sparrow.stock.doctype.inventory_dimension.inventory_dimension import get_inventory_dimensions
...
class StockReconciliation(StockController):
	...
	def recalculate_current_qty(self, voucher_detail_no, sle_creation, add_new_sle=False):
		from sparrow.stock.stock_ledger import get_valuation_rate
...
def get_itemwise_batch(warehouse, posting_date, company, item_code=None):
	from sparrow.stock.report.batch_wise_balance_history.batch_wise_balance_history import execute
