...
sparrow.stock.LandedCostVoucher = class LandedCostVoucher extends sparrow.stock.StockController {
	setup() {
		var me = this;
...
cur_frm.script_manager.make(sparrow.stock.LandedCostVoucher);
