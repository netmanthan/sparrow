...
from sparrow.accounts.utils import get_balance_on
...
from sparrow.stock.doctype.delivery_note.delivery_note import (
	make_delivery_trip,
	make_sales_invoice,
)
from sparrow.stock.doctype.item.test_item import make_item
from sparrow.stock.doctype.purchase_receipt.test_purchase_receipt import get_gl_entries
from sparrow.stock.doctype.serial_no.serial_no import SerialNoWarehouseError, get_serial_nos
...
class TestDeliveryNote(FrappeTestCase):
	...
	def test_closed_delivery_note(self):
		from sparrow.stock.doctype.delivery_note.delivery_note import update_delivery_note_status
	...
	def test_dn_billing_status_case2(self):
		...
		from sparrow.selling.doctype.sales_order.sales_order import (
			make_delivery_note,
			make_sales_invoice,
		)
	...
	def test_dn_billing_status_case3(self):
		...
		from sparrow.selling.doctype.sales_order.sales_order import make_delivery_note
		from sparrow.selling.doctype.sales_order.sales_order import (
	...
	def test_dn_billing_status_case4(self):
		# SO -> SI -> DN
		from sparrow.accounts.doctype.sales_invoice.sales_invoice import make_delivery_note
		from sparrow.selling.doctype.sales_order.sales_order import make_sales_invoice
	...
	def test_packed_items_for_return_delivery_note(self):
		...
		from sparrow.stock.doctype.stock_ledger_entry.test_stock_ledger_entry import (
