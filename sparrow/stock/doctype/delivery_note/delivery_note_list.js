frappe.listview_settings['Delivery Note'] = {
	...
	onload: function (doclist) {
		...
		doclist.page.add_action_item(__("Sales Invoice"), ()=>{
			sparrow.bulk_transaction_processing.create(doclist, "Delivery Note", "Sales Invoice");
		});

		doclist.page.add_action_item(__("Packaging Slip From Delivery Note"), ()=>{
			sparrow.bulk_transaction_processing.create(doclist, "Delivery Note", "Packing Slip");
		});
	}
};
