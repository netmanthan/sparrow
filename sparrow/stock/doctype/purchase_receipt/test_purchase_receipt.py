...
import sparrow
from sparrow.accounts.doctype.account.test_account import get_inventory_account
from sparrow.controllers.buying_controller import QtyMismatchError
from sparrow.stock.doctype.item.test_item import create_item, make_item
from sparrow.stock.doctype.purchase_receipt.purchase_receipt import make_purchase_invoice
from sparrow.stock.doctype.serial_no.serial_no import SerialNoDuplicateError, get_serial_nos
from sparrow.stock.doctype.warehouse.test_warehouse import create_warehouse
from sparrow.stock.stock_ledger import SerialNoExistsInFutureTransaction
...
class TestPurchaseReceipt(FrappeTestCase):
	...
	def test_make_purchase_invoice(self):
		from sparrow.accounts.doctype.payment_entry.test_payment_entry import create_payment_term
	...
	def test_purchase_receipt_no_gl_entry(self):
		from sparrow.stock.doctype.stock_entry.test_stock_entry import make_stock_entry
	...
	def test_purchase_receipt_gl_entry(self):
		...
		self.assertEqual(cint(sparrow.is_perpetual_inventory_enabled(pr.company)), 1)
	...
	def test_purchase_return_for_rejected_qty(self):
		from sparrow.stock.doctype.warehouse.test_warehouse import get_warehouse
	...
	def test_closed_purchase_receipt(self):
		from sparrow.stock.doctype.purchase_receipt.purchase_receipt import (
	...
	def test_pr_billing_status(self):
		...
		3. PO -> PR2.
		"""
		from sparrow.buying.doctype.purchase_order.purchase_order import (
		...
		from sparrow.buying.doctype.purchase_order.test_purchase_order import create_purchase_order
	...
	def test_purchase_return_with_submitted_asset(self):
		from sparrow.stock.doctype.purchase_receipt.purchase_receipt import make_purchase_return
	...
	def test_make_purchase_invoice_from_pr_for_returned_qty(self):
		from sparrow.buying.doctype.purchase_order.test_purchase_order import (
	...
	def test_stock_transfer_from_purchase_receipt(self):
		from sparrow.stock.doctype.delivery_note.delivery_note import make_inter_company_purchase_receipt
		from sparrow.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
	...
	def test_po_to_pi_and_po_to_pr_worflow_full(self):
		...
		"""
		from sparrow.buying.doctype.purchase_order import purchase_order, test_purchase_order
	...
	def test_purchase_receipt_with_exchange_rate_difference(self):
		from sparrow.accounts.doctype.purchase_invoice.purchase_invoice import (
		...
		from sparrow.accounts.party import add_party_account
	...
	def test_payment_terms_are_fetched_when_creating_purchase_invoice(self):
		from sparrow.accounts.doctype.payment_entry.test_payment_entry import (
			create_payment_terms_template,
		)
		from sparrow.accounts.doctype.purchase_invoice.test_purchase_invoice import make_purchase_invoice
		from sparrow.buying.doctype.purchase_order.test_purchase_order import (
			create_purchase_order,
			make_pr_against_po,
		)
		from sparrow.selling.doctype.sales_order.test_sales_order import (
	...
	def test_backdated_transaction_for_internal_transfer_in_trasit_warehouse_for_purchase_invoice(
		...
		from sparrow.accounts.doctype.sales_invoice.sales_invoice import (
			make_inter_company_purchase_invoice,
		)
		from sparrow.accounts.doctype.sales_invoice.test_sales_invoice import create_sales_invoice
	...
	def test_validate_received_qty_for_internal_pr(self):
		...
		from sparrow.controllers.status_updater import OverAllowanceError
		from sparrow.stock.doctype.delivery_note.delivery_note import make_inter_company_purchase_receipt
	...
	def test_internal_pr_gl_entries(self):
		from sparrow.stock import get_warehouse_account_map
		from sparrow.stock.doctype.delivery_note.delivery_note import make_inter_company_purchase_receipt
		from sparrow.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
		from sparrow.stock.doctype.stock_entry.test_stock_entry import make_stock_entry
	...
	def test_purchase_receipt_with_backdated_landed_cost_voucher(self):
		from sparrow.controllers.sales_and_purchase_return import make_return_doc
		from sparrow.stock.doctype.landed_cost_voucher.test_landed_cost_voucher import (
	...
	def test_purchase_receipt_provisional_accounting(self):
		...
		from sparrow.accounts.doctype.account.test_account import create_account
	...
	def test_valuation_rate_in_return_purchase_receipt_for_moving_average(self):
		from sparrow.stock.doctype.stock_entry.test_stock_entry import make_stock_entry
		from sparrow.stock.stock_ledger import get_previous_sle
...
def prepare_data_for_internal_transfer():
	from sparrow.accounts.doctype.sales_invoice.test_sales_invoice import create_internal_supplier
