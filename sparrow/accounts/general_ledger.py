...
from sparrow.accounts.doctype.accounting_period.accounting_period import ClosedAccountingPeriod
from sparrow.accounts.doctype.budget.budget import validate_expense_against_budget
from sparrow.accounts.utils import create_payment_ledger_entry
...
def merge_similar_entries(gl_map, precision=None):
	...
	company = gl_map[0].company if gl_map else sparrow.get_default_company()
