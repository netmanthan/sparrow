...
class RepostAccountingLedger(Document):
	...
	def generate_preview(self):
		from sparrow.accounts.report.general_ledger.general_ledger import get_columns as get_gl_columns
		...
		rendered_page = frappe.render_template(
			"sparrow/accounts/doctype/repost_accounting_ledger/repost_accounting_ledger.html",
	...
	def on_submit(self):
		if len(self.vouchers) > 1:
			...
			frappe.enqueue(
				method="sparrow.accounts.doctype.repost_accounting_ledger.repost_accounting_ledger.start_repost",
