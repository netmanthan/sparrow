...
from sparrow.accounts.utils import _delete_pl_entries, create_payment_ledger_entry
...
def execute_repost_payment_ledger(docname):
	...
	frappe.enqueue(
		method="sparrow.accounts.doctype.repost_payment_ledger.repost_payment_ledger.start_payment_ledger_repost",
		docname=docname,
		is_async=True,
		job_name=job_name,
	)
