...
sparrow.selling.POSInvoiceController = class POSInvoiceController extends sparrow.selling.SellingController {
	settings = {};
...
extend_cscript(cur_frm.cscript, new sparrow.selling.POSInvoiceController({ frm: cur_frm }))
