...
from sparrow.accounts.doctype.accounting_dimension_filter.accounting_dimension_filter import (
	get_dimension_filter_map,
)
from sparrow.accounts.party import validate_party_frozen_disabled, validate_party_gle_currency
...
class GLEntry(Document):
	...
	def validate_currency(self):
		company_currency = sparrow.get_company_currency(self.company)
...
def update_against_account(voucher_type, voucher_no):
	...
	if not entries:
		return
	company_currency = sparrow.get_company_currency(entries[0].company)
