...
frappe.provide("sparrow.cheque_print");
	...
	refresh: function(frm) {
		if(!frm.doc.__islocal) {
			frm.add_custom_button(frm.doc.has_print_format?__("Update Print Format"):__("Create Print Format"),
				function() {
					sparrow.cheque_print.view_cheque_print(frm);
...
sparrow.cheque_print.view_cheque_print = function(frm) {
	frappe.call({
		method: "sparrow.accounts.doctype.cheque_print_template.cheque_print_template.create_or_update_cheque_print_format",
		args:{
