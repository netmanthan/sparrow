...
from sparrow.accounts.general_ledger import (
	get_round_off_account_and_cost_center,
	make_gl_entries,
	make_reverse_gl_entries,
	merge_similar_entries,
)
from sparrow.accounts.party import get_due_date, get_party_account
from sparrow.accounts.utils import get_account_currency, get_fiscal_year
from sparrow.assets.doctype.asset.asset import is_cwip_accounting_enabled
from sparrow.assets.doctype.asset_category.asset_category import get_asset_category_account
from sparrow.buying.utils import check_on_hold_or_closed_status
from sparrow.controllers.accounts_controller import validate_account_head
from sparrow.controllers.buying_controller import BuyingController
...
class PurchaseInvoice(BuyingController):
	...
	def on_submit(self):
		...
		if self.update_stock == 1:
			...
			from sparrow.stock.doctype.serial_no.serial_no import update_serial_nos_after_submit
	...
	def get_gl_entries(self, warehouse_account=None):
		self.auto_accounting_for_stock = sparrow.is_perpetual_inventory_enabled(self.company)
	...
	def update_billing_status_in_pr(self, update_modified=True):
		...
		for pr in set(updated_pr):
			from sparrow.stock.doctype.purchase_receipt.purchase_receipt import update_billing_percentage
