...
from sparrow.accounts.party import get_party_account_currency
from sparrow.accounts.report.accounts_receivable.accounts_receivable import execute as get_ar_soa
from sparrow.accounts.report.accounts_receivable_summary.accounts_receivable_summary import (
	execute as get_ageing,
)
from sparrow.accounts.report.general_ledger.general_ledger import execute as get_soa
...
def get_html(doc, filters, entry, col, res, ageing):
	...
	template_path = (
		"sparrow/accounts/doctype/process_statement_of_accounts/process_statement_of_accounts.html"
		if doc.report == "General Ledger"
		else "sparrow/accounts/doctype/process_statement_of_accounts/process_statement_of_accounts_accounts_receivable.html"
	)
