...
class TestTaxDetail(unittest.TestCase):
	def load_testdocs(self):
		from sparrow.accounts.utils import FiscalYearError, get_fiscal_year
	...
	def rm_testdocs(self):
		...
		from sparrow.setup.doctype.company.company import create_transaction_deletion_request
