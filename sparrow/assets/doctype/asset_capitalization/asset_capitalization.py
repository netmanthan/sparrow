...
import sparrow
from sparrow.assets.doctype.asset.asset import get_asset_value_after_depreciation
...
from sparrow.stock.utils import get_incoming_rate
		...
		for item_row in self.stock_items:
			...
			if sle_list:
				for sle in sle_list:
					...
					if sparrow.is_perpetual_inventory_enabled(self.company):
