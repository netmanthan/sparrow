...
from sparrow.e_commerce.doctype.item_review.item_review import get_item_reviews
from sparrow.e_commerce.redisearch_utils import (
	delete_item_from_index,
	insert_item_to_index,
	update_index_for_item,
)
from sparrow.e_commerce.shopping_cart.cart import _set_price_list
from sparrow.setup.doctype.item_group.item_group import (
...
class WebsiteItem(WebsiteGenerator):
	...
	def set_metatags(self, context):
		...
		context.metatags["og:site_name"] = "Sparrow"
...
def invalidate_cache_for_web_item(doc):
	...
	from sparrow.stock.doctype.item.item import invalidate_item_variants_cache_for_website
