...
from sparrow.e_commerce.doctype.item_review.item_review import get_customer
from sparrow.e_commerce.shopping_cart.product_info import get_product_info_for_website
from sparrow.utilities.product import get_non_stock_item_status
...
class ProductQuery:
	...
	def build_item_group_filters(self, item_group):
		...
		from sparrow.setup.doctype.item_group.item_group import get_child_groups_for_website
	...
	def get_stock_availability(self, item):
		from sparrow.templates.pages.wishlist import (
