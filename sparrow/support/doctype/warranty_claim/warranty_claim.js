...
frappe.provide("sparrow.support");
...
sparrow.support.WarrantyClaim = class WarrantyClaim extends frappe.ui.form.Controller {
	refresh() {
...
extend_cscript(cur_frm.cscript, new sparrow.support.WarrantyClaim({frm: cur_frm}));
