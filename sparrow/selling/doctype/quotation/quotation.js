...
sparrow.selling.QuotationController = class QuotationController extends sparrow.selling.SellingController {
	onload(doc, dt, dn) {
	...
	get_lead_details() {
		...
		frappe.call({
			method: "sparrow.crm.doctype.lead.lead.get_lead_details",
			args: {
...
cur_frm.script_manager.make(sparrow.selling.QuotationController);
