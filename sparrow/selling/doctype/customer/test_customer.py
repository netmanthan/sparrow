...
from sparrow.accounts.party import get_due_date
from sparrow.exceptions import PartyDisabled, PartyFrozen
from sparrow.selling.doctype.customer.customer import get_credit_limit, get_customer_outstanding
...
class TestCustomer(FrappeTestCase):
	...
	def test_party_details(self):
		from sparrow.accounts.party import get_party_details
	...
	def test_serach_fields_for_customer(self):
		from sparrow.controllers.queries import customer_query
