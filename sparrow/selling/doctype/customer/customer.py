...
from sparrow.accounts.party import (  # noqa
	get_dashboard_info,
	get_timeline_data,
...
def get_customer_list(doctype, txt, searchfield, start, page_len, filters=None):
	...
	from sparrow.controllers.queries import get_fields

	deprecation_warning(
		"`get_customer_list` is deprecated and will be removed in version 15. Use `sparrow.controllers.queries.customer_query` instead."
	)
	...
	if credit_limit > 0 and flt(customer_outstanding) > credit_limit:
		...
		if not credit_controller_role or credit_controller_role not in frappe.get_roles():
			...
			frappe.msgprint(
				...
				primary_action={
					"label": "Send Email",
					"server_action": "sparrow.selling.doctype.customer.customer.send_emails",
					"args": {
						"customer": customer,
