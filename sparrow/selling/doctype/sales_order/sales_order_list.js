frappe.listview_settings['Sales Order'] = {
	...
	onload: function(listview) {
		var method = "sparrow.selling.doctype.sales_order.sales_order.close_or_unclose_sales_orders";
		...
		listview.page.add_action_item(__("Sales Invoice"), ()=>{
			sparrow.bulk_transaction_processing.create(listview, "Sales Order", "Sales Invoice");
		});

		listview.page.add_action_item(__("Delivery Note"), ()=>{
			sparrow.bulk_transaction_processing.create(listview, "Sales Order", "Delivery Note");
		});

		listview.page.add_action_item(__("Advance Payment"), ()=>{
			sparrow.bulk_transaction_processing.create(listview, "Sales Order", "Payment Entry");
		});
