...
sparrow.LeadController = class LeadController extends frappe.ui.form.Controller {
	setup () {
	...
	add_lead_to_prospect () {
		...
		function(data) {
			frappe.call({
				method: 'sparrow.crm.doctype.lead.lead.add_lead_to_prospect',
				args: {
	...
	make_customer () {
		frappe.model.open_mapped_doc({
			method: "sparrow.crm.doctype.lead.lead.make_customer",
			frm: cur_frm
		})
	}
	...
	make_quotation () {
		frappe.model.open_mapped_doc({
			method: "sparrow.crm.doctype.lead.lead.make_quotation",
			frm: cur_frm
		})
	}
...
extend_cscript(cur_frm.cscript, new sparrow.LeadController({ frm: cur_frm }));
