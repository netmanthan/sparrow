...
from sparrow.accounts.party import get_due_date_from_template
from sparrow.buying.doctype.purchase_order.purchase_order import make_inter_company_sales_order
...
class TestPurchaseOrder(FrappeTestCase):
	...
	def test_purchase_order_invoice_receipt_workflow(self):
		from sparrow.accounts.doctype.purchase_invoice.purchase_invoice import make_purchase_receipt
	...
	def test_warehouse_company_validation(self):
		from sparrow.stock.utils import InvalidWarehouseCompany

		po = create_purchase_order(company="_Test Company 1", do_not_save=True)
		self.assertRaises(InvalidWarehouseCompany, po.insert)

	def test_uom_integer_validation(self):
		from sparrow.utilities.transaction_base import UOMMustBeIntegerError
