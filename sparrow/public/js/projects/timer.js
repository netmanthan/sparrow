frappe.provide("sparrow.timesheet");

sparrow.timesheet.timer = function(frm, row, timestamp=0) {
	...
	sparrow.timesheet.control_timer(frm, dialog, row, timestamp);
	dialog.show();
};

sparrow.timesheet.control_timer = function(frm, dialog, row, timestamp=0) {
