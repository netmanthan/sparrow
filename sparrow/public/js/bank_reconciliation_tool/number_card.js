...
sparrow.accounts.bank_reconciliation.NumberCardManager = class NumberCardManager {
	constructor(opts) {
	...
	make_cards() {
		...
		chart_data.forEach((summary) => {
			let number_card = new sparrow.accounts.NumberCard(summary);
...
sparrow.accounts.NumberCard = class NumberCard {
	constructor(options) {
