frappe.provide("sparrow.bulk_transaction_processing");

$.extend(sparrow.bulk_transaction_processing, {
	create: function(listview, from_doctype, to_doctype) {
		...
		frappe.confirm(__("Create {0} {1} ?", [count_of_rows, to_doctype]), ()=>{
			if (doc_name.length == 0) {
				frappe.call({
					method: "sparrow.utilities.bulk_transaction.transaction_processing",
