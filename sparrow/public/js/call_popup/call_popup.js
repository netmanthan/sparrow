		...
		this.call_details = new frappe.ui.FieldGroup({
			fields: [{
				...
				'click': () => {
					...
					frappe.xcall('sparrow.telephony.doctype.call_log.call_log.add_call_summary_and_call_type', {
