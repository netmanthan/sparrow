frappe.provide("sparrow.e_commerce.wishlist");
var wishlist = sparrow.e_commerce.wishlist;

frappe.provide("sparrow.e_commerce.shopping_cart");
var shopping_cart = sparrow.e_commerce.shopping_cart;
...
$.extend(wishlist, {
	...
	wishlist_action(btn) {
		...
		let success_action = function() {
			sparrow.e_commerce.wishlist.set_wishlist_count(true);
		};
	...
	add_remove_from_wishlist(action, args, success_action, failure_action, async=false) {
		...
		if (frappe.session.user==="Guest") {
			...
			let method = "sparrow.e_commerce.doctype.wishlist.wishlist.add_to_wishlist";
			if (action === "remove") {
				method = "sparrow.e_commerce.doctype.wishlist.wishlist.remove_from_wishlist";
			}
	...
	redirect_guest() {
		frappe.call('sparrow.e_commerce.api.get_guest_redirect_on_action').then((res) => {
		...
		$(".page_content").append(`
			<div class="cart-empty frappe-card">
				<div class="cart-empty-state">
					<img src="/assets/sparrow/images/ui-states/cart-empty-state.png" alt="Empty Cart">
				</div>
