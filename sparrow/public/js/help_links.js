...
frappe.help.help_links["Form/Rename Tool"] = [
	{
		label: "Bulk Rename",
		url: docsUrl + "user/manual/en/using-sparrow/articles/bulk-rename",
	},
];
...
frappe.help.help_links["List/Authorization Rule"] = [
	{
		...
		url: docsUrl + "user/manual/en/customize-sparrow/authorization-rule",
	},
];
...
frappe.help.help_links["Form/Customize Form"] = [
	{
		label: "Custom Field",
		url: docsUrl + "user/manual/en/customize-sparrow/custom-field",
	},
	{
		label: "Customize Field",
		url: docsUrl + "user/manual/en/customize-sparrow/customize-form",
	},
];
